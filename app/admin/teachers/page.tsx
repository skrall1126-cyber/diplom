        ...
        >
          <div className="mx-auto max-w-7xl space-y-6">
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { label: "Нийт багш", value: summaryStats.totalTeachers, icon: "👨‍🏫", color: "bg-blue-500" },
                { label: "Идэвхтэй багш", value: summaryStats.active, icon: "✅", color: "bg-emerald-500" },
                { label: "Дундаж үнэлгээ", value: summaryStats.averageRating, icon: "⭐", color: "bg-amber-500" },
                { label: "Нийт оюутан", value: summaryStats.totalStudents, icon: "👥", color: "bg-purple-500" },
              ].map((stat, index) => (
